package com.jasonchen.graphicsLib;
...
public class G {
    ...
    public static class V implements Serializable{
        ...
        public static class Transform {
            ...
            public void set(BBox box, VS vs) {
                setScale(box.h.size(), box.v.size(), vs.size.x, vs.size.y);
                dx = setOff(box.h.lo, box.h.size(), vs.loc.x, vs.size.x);
                dy = setOff(box.v.lo, box.v.size(), vs.loc.y, vs.size.y);
            }
        }
    }
    // ------------------------------------------------------
    ...
    public static class PL implements Serializable {
        ...
        public void drawN(Graphics g, int n) {
            for (int i = 1; i < n; i++) {
                ...
                g.drawOval(points[i - 1].x - 2, points[i - 1].y - 2, 4, 4);
            }
        }
